const sendOtp = (mobile_number, next) => {
...
const resendOtp = (mobile_number, next) => {
...
const verifyOtp = (mobile_number, otp, next) => {
...
const sendEmailOtp = (email, otp, next)=> {
    var http = require("https");
...
module.exports = { sendOtp, resendOtp, verifyOtp, sendEmailOtp };