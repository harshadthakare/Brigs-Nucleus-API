class Auth {
    ...
    getSuperAdminByAuthSQL() {
        let sql = `SELECT superAdminId,firstName,lastName,mobileNumber,emailId 
                   FROM superadmin WHERE emailId ='${this.emailId}' AND password= '${this.password}'`;
        return sql;
    }
