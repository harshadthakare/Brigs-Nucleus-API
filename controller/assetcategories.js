...
/**
 * @swagger
 * /assetcategories/assetCategoryList/{parentId}:
 *   get:
 *     tags:
 *       - AssetCategory
...
router.get("/assetCategoryList/:parentId", (req, res, next) => {
    verifyToken(req, res, organizationIdFK => {
        let parentId = req.params.parentId;

        db.query(AssetCategory.getAllAssetCategories(parentId, organizationIdFK), (err, data) => {
            if (!err) {
